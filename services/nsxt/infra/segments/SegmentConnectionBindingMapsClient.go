...
type SegmentConnectionBindingMapsClient interface {
	...
	Delete(segmentIdParam string, mapIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(segmentIdParam string, mapIdParam string) (nsx_policyModel.SegmentConnectionBindingMap, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(segmentIdParam string, mapIdParam string, segmentConnectionBindingMapParam nsx_policyModel.SegmentConnectionBindingMap) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(segmentIdParam string, mapIdParam string, segmentConnectionBindingMapParam nsx_policyModel.SegmentConnectionBindingMap) (nsx_policyModel.SegmentConnectionBindingMap, error)
}
...
func NewSegmentConnectionBindingMapsClient(connector vapiProtocolClient_.Connector) *segmentConnectionBindingMapsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.segments.segment_connection_binding_maps")
...
func (sIface *segmentConnectionBindingMapsClient) Delete(segmentIdParam string, mapIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.segments.segment_connection_binding_maps", "delete", inputDataValue, executionContext)
...
func (sIface *segmentConnectionBindingMapsClient) Get(segmentIdParam string, mapIdParam string) (nsx_policyModel.SegmentConnectionBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.segments.segment_connection_binding_maps", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentConnectionBindingMap
	if methodResult.IsSuccess() {
...
func (sIface *segmentConnectionBindingMapsClient) Patch(segmentIdParam string, mapIdParam string, segmentConnectionBindingMapParam nsx_policyModel.SegmentConnectionBindingMap) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.segments.segment_connection_binding_maps", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *segmentConnectionBindingMapsClient) Update(segmentIdParam string, mapIdParam string, segmentConnectionBindingMapParam nsx_policyModel.SegmentConnectionBindingMap) (nsx_policyModel.SegmentConnectionBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.segments.segment_connection_binding_maps", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentConnectionBindingMap
	if methodResult.IsSuccess() {
